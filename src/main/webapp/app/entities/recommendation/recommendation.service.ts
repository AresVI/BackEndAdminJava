...
export class RecommendationService {
    ...
    private resourceUrl = SERVER_API_URL + 'api/recommendations';

    constructor(private http: Http, private dateUtils: JhiDateUtils) { }

    create(recommendation: Recommendation): Observable<Recommendation> {
        const copy = this.convert(recommendation);
    ...
    update(recommendation: Recommendation): Observable<Recommendation> {
        const copy = this.convert(recommendation);
    ...
    find(id: number): Observable<Recommendation> {
